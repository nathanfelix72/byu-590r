...
stop:
	...
	@ps aux | grep -v grep | grep "ng serve" | awk '{print $$2}' | xargs -r kill -9 2>/dev/null || true
	@ps aux | grep -v grep | grep "npm start" | awk '{print $$2}' | xargs -r kill -9 2>/dev/null || true
